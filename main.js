/* Porsche 718 Cayman Style Edition — Apple-style scroll film
...
function drawFrame(i) {
  ...
  // contain: frames are 4:3 or 16:9, viewport usually wider — vignette hides the seam
...
function devPlaceholder(msg) {
  ...
  const draw = () => {
    ...
    g.addColorStop(0, "#141214");
    g.addColorStop(1, "#060506");
    ctx.fillStyle = g;
    ctx.fillRect(0, 0, canvas.width, canvas.height);
    ctx.fillStyle = "rgba(210, 59, 111, 0.85)";
...
loadManifest()
  ...
  .catch(() => devPlaceholder("Frames not built yet. Generate images and run scripts/build_master.py to compile."));
